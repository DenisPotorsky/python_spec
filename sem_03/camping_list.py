...
bucket_list = {'GPS навигатор': 150, 'Палатка': 3000, 'Спальный мешок': 500, 'Котелок': 2000, 'Спички': 5,
               'Антимоскитный спрей': 50, 'Продукты': 5000, 'Инструменты': 4000, 'Матрас самонадувайка': 1500,
               'Powerbank': 300}
